...
public class ThreePointCrosserTest {
    ...
    public void shouldSwapBytesCorrectly() {
        ...
        Assert.assertSame(1, (int) solution1.getChromosomesBytes().get(0)[1]);
        Assert.assertSame(0, (int) solution1.getChromosomesBytes().get(0)[2]);
        Assert.assertSame(1, (int) solution1.getChromosomesBytes().get(0)[3]);
        Assert.assertSame(1, (int) solution1.getChromosomesBytes().get(0)[4]);

        Assert.assertSame(1, (int) solution2.getChromosomesBytes().get(0)[0]);
        Assert.assertSame(0, (int) solution2.getChromosomesBytes().get(0)[1]);
        Assert.assertSame(1, (int) solution2.getChromosomesBytes().get(0)[2]);
        Assert.assertSame(0, (int) solution2.getChromosomesBytes().get(0)[3]);
        Assert.assertSame(0, (int) solution2.getChromosomesBytes().get(0)[4]);
    }
